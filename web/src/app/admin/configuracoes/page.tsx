    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl bg-white border border-slate-100 shadow-sm p-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <h2 className="text-lg font-bold text-slate-900">Organizers</h2>
            <p className="text-sm text-slate-600">Cadastre usuários com perfil organizador para administrar torneios.</p>
          </div>
          <Link
